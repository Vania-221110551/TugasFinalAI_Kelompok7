...
class _HomePageState extends State<RecognitionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Face Recognition",style: TextStyle(fontFamily: "PlusJakartaSans"),),
      ),
      body: Column(
...
class FacePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (Recognition face in facesList) {
      ...
      TextSpan textSpan = TextSpan(text: face.name, style: TextStyle(color: Colors.white, fontSize: 20));
